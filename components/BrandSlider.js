        ...
        <div className="brand-list">
          ...
          >
            <div className="swiper-wrapper mt-slide-transtion">
              <SwiperSlide className="swiper-slide mt-brand-slide-element ">
