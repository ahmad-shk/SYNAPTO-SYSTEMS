    ...
    <Swiper {...sliderProps.brandSlider} className="swiper brand-slider">
      <div className="swiper-wrapper">
        <SwiperSlide className="swiper-slide">
          <div className="brand-image" style={{ display: "flex", alignItems: "center", justifyContent: "center", height: "80px" }}>
            <img src="/assets/img/brand/logo.svg" alt="img" style={{ width: "160px", height: "80px", objectFit: "contain" }} />
          </div>
        </SwiperSlide>
        <SwiperSlide className="swiper-slide">
          <div className="brand-image" style={{ display: "flex", alignItems: "center", justifyContent: "center", height: "80px" }}>
            <img src="/assets/img/brand/khim.svg" alt="img" style={{ width: "160px", height: "80px", objectFit: "contain" }} />
          </div>
        </SwiperSlide>
        <SwiperSlide className="swiper-slide">
          <div className="brand-image" style={{ display: "flex", alignItems: "center", justifyContent: "center", height: "80px" }}>
