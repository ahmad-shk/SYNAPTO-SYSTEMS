...
function loadGoogleTagManager() {
  ...
  const GTM_ID = 'GTM-NJK8BVJC'; // TODO: replace with your real GTM ID
  if (!GTM_ID) return;
...
function handleConsentForMarketing(cookie) {
  if (!cookie) return;
    ...
    translations: {
      de: {
        consentModal: {
          ...
          description:
            'Wir verwenden Cookies, um unsere Website zu betreiben, die Nutzung zu analysieren und unser Angebot zu verbessern. Nicht notwendige Cookies werden nur gesetzt, wenn Sie zustimmen. Weitere Informationen finden Sie in unserer <a href="/privacy-policy" class="cc__link">Datenschutzerklärung</a> und in unserer <a href="/cookie-policy" class="cc__link">Cookie-Richtlinie</a>.',
        ...
        preferencesModal: {
          ...
          sections: [
            ...
            },
            {
              ...
              description:
                'Ausführliche Informationen zur Verarbeitung personenbezogener Daten, zu Ihren Rechten (Auskunft, Berichtigung, Löschung, Einschränkung, Widerspruch, Datenübertragbarkeit) sowie zu Ihrem Beschwerderecht bei der Datenschutzbehörde finden Sie in unserer <a class="cc__link" href="/privacy-policy">Datenschutzerklärung</a>.',
            },
          ],
        },
      },
